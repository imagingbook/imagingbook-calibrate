...
class RotationsTest {
    ...
    void makeRotationPermutation1() {
        int[] perm = MatrixRotationUtils.makeRotationPermutation(1);
        int[] expected = { 0 };
    ...
    void makeRotationPermutation2() {
        int[] perm = MatrixRotationUtils.makeRotationPermutation(2);
    ...
    void makeRotationPermutation3() {
        int[] perm = MatrixRotationUtils.makeRotationPermutation(3);
    ...
    void makeRotationPermutation4() {
        int[] perm = MatrixRotationUtils.makeRotationPermutation(4);
    ...
    void makeRotationPermutation5() {
        int[] perm = MatrixRotationUtils.makeRotationPermutation(5);
    ...
    void makeRotationPermutation7() {
        int[] perm = MatrixRotationUtils.makeRotationPermutation(7);
    ...
    void permuteTest0() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            MatrixRotationUtils.permute(data, perm);
        });
    }
    ...
    void permuteTest1() {
        ...
        char[] datap = MatrixRotationUtils.permute(data, perm);
