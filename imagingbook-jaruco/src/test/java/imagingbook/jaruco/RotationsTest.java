...
class RotationsTest {
    ...
    void makeRotationPermutation1() {
        int[] perm = Rotations.makeRotationPermutation(1);
        int[] expected = { 0 };
    ...
    void makeRotationPermutation2() {
        int[] perm = Rotations.makeRotationPermutation(2);
    ...
    void makeRotationPermutation3() {
        int[] perm = Rotations.makeRotationPermutation(3);
    ...
    void makeRotationPermutation4() {
        int[] perm = Rotations.makeRotationPermutation(4);
    ...
    void makeRotationPermutation5() {
        int[] perm = Rotations.makeRotationPermutation(5);
    ...
    void makeRotationPermutation7() {
        int[] perm = Rotations.makeRotationPermutation(7);
    ...
    void permuteTest1() {
        ...
        char[] datap = Rotations.permute(data, perm);
