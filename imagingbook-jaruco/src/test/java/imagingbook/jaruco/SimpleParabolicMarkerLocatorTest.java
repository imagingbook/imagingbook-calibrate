...
class SimpleParabolicMarkerLocatorTest {

    @Test
    void fitOverXYTest() {
        // fit parabola over X:
        List<Pnt2d> polyX = PntUtils.makePntList(0, 0, 0.25, 0.5, 0.5, 0.75, 0.2, 1.0, 1, 0);  // (x,y)
        Parabola.ParabolaX fitX = SimpleParabolicMarkerLocator.fitOverX(polyX, 0.5);
        ...
        Parabola.ParabolaY fitY = SimpleParabolicMarkerLocator.fitOverY(polyY, 0.5);
