...
public class ParabolaIntersectionFinder2 {
    ...
    private static double F0(QuadraticFunction Q0, double x, double y) {
        return y - Q0.getVal(x);
    }

    private static double F1(QuadraticFunction Q1, double x, double y) {
        return x - Q1.getVal(y);
    }

    // ----------------------------------------------------------------------------

    public double[] getIntersection (QuadraticFunction Q0, QuadraticFunction Q1, double x0, double y0) {
        double x = x0;
        double y = y0;
        int iterations = 0;
