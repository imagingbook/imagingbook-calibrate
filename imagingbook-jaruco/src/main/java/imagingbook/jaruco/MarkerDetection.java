...
public class MarkerDetection {
    ...
    // Constructor (private).
    private MarkerDetection(int markerId, int rotation, int hDist,
    ...
    /**
     * Builds a {@link MarkerDetection} from a given {@link ArucoDictionary.LookupResult}
     ...
     */
    MarkerDetection(ArucoDictionary.LookupResult lookupR, MarkerOutline corners, Pnt2d[] rejectedPoints) {
