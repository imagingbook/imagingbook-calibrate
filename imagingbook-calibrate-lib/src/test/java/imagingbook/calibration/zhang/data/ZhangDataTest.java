...
import static imagingbook.calibration.zhang.data.StandardModel.NumberOfModelPoints;
import static imagingbook.calibration.zhang.data.ZhangData.NumberOfViews;
...
public class ZhangDataTest {
    ...
    public void getCamera() {
        ...
        assertTrue(cam.getDistortion() instanceof Radial2TermDistortion);
