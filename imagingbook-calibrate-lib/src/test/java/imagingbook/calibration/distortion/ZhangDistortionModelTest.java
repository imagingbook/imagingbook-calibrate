...
public class ZhangDistortionModelTest {
    static final double tol = 1e-6;
    static final double k0 = 0.2, k1 = -0.05;

    @Test
    public void copyOfTest1() {
        ZhangDistortionModel m1 = new ZhangDistortionModel();
        assertArrayEquals(new double[] {0, 0}, m1.getParameters(), tol);
        ZhangDistortionModel m2 = m1.copyOf(k0, k1);
    ...
    public void getParametersTest() {
        ZhangDistortionModel m1 = new ZhangDistortionModel(k0, k1);
        assertArrayEquals(new double[] {k0, k1}, m1.getParameters(), tol);
        ZhangDistortionModel m2 = new ZhangDistortionModel();
