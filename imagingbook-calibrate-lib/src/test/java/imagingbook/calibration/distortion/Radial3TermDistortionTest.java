...
public class Radial3TermDistortionTest {
    ...
    public void constructorTest1() {
        LensDistortion ldm = new Radial3TermDistortion(k0, k1, k2);
    ...
    public void constructorTest2() {
        LensDistortion ldm = new Radial3TermDistortion();
        double[] params = ldm.getParameters();
        assertEquals(3, params.length);
    ...
    public void constructorExceptionTest1() {
        LensDistortion ldm = new Radial3TermDistortion(0.1);
    }

    @Test (expected = IllegalArgumentException.class)
    public void constructorExceptionTest2() {
        LensDistortion ldm = new Radial3TermDistortion(0.1, 0.7);
    }

    @Test (expected = IllegalArgumentException.class)
    public void constructorExceptionTest3() {
        LensDistortion ldm = new Radial3TermDistortion(0.1, 0.7, 0, -0.1);
    }
    ...
    public void copyOfTest() {
        ...
        LensDistortion ldm3 = ldm.copyOf(0.4, -0.1, 0.5);
    ...
    public void fRadTest() {
        RadialDistortion ldm = new Radial3TermDistortion(k0, k1, k2);
        double r1 = 0.35;
