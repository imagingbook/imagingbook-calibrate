...
public class LensDistortionModelTest {
    ...
    public void copyOfTest1() {
        LensDistortionModel m1 = new ZhangDistortionModel();
        LensDistortionModel m2 = m1.copyOf(k0, k1);
        assertArrayEquals(new double[] {k0, k1}, m2.getParameters(), tol);
        assertEquals(ZhangDistortionModel.class, m1.getClass());
        assertEquals(ZhangDistortionModel.class, m2.getClass());
    }

    @Test (expected = IllegalArgumentException.class)
    public void copyOfTest2() {
        LensDistortionModel m1 = new ZhangDistortionModel(k0, k1);
        LensDistortionModel m2 = m1.copyOf(k0, k1, 0.1);    // too many arguments
    }

    @Test (expected = IllegalArgumentException.class)
    public void copyOfTest3() {
        LensDistortionModel m1 = new ZhangDistortionModel(k0, k1);
        LensDistortionModel m2 = m1.copyOf(0.1);    // too few arguments
    }
    ...
    public void getParameterCountTest() {
        ...
        LensDistortionModel m2 = new ZhangDistortionModel();
