...
public class Radial3TermDistortionTest {
    ...
    public void constructorTest1() {
        DistortionModel ldm = new Radial3TermDistortion(new double[] {k0, k1, k2});
    ...
    public void constructorTest2() {
        DistortionModel ldm = new Radial3TermDistortion();
        double[] params = ldm.getParameters();
        assertEquals(3, params.length);
    ...
    public void constructorExceptionTest1() {
        DistortionModel ldm = new Radial3TermDistortion(new double[] {0.1});
    }

    @Test (expected = IllegalArgumentException.class)
    public void constructorExceptionTest2() {
        DistortionModel ldm = new Radial3TermDistortion(new double[] {0.1, 0.7});
    }

    @Test (expected = IllegalArgumentException.class)
    public void constructorExceptionTest3() {
        DistortionModel ldm = new Radial3TermDistortion(new double[] {0.1, 0.7, 0, -0.1});
    }
    ...
    public void copyOfTest() {
        ...
        DistortionModel ldm2 = ldm.withParameters(ldm.getParameters());
        assertNotNull(ldm2);
        assertEquals(k0, ldm2.getParameter(0), tol);
        assertEquals(k1, ldm2.getParameter(1), tol);
        assertEquals(k2, ldm2.getParameter(2), tol);

        DistortionModel ldm3 = ldm.withParameters(new double[] {0.4, -0.1, 0.5});
